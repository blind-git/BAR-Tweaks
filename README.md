...
> | Tier | Units |
> |------|--------|
> | **T1** | **Arm:** ZAPPER (EMP Scout - enhanced speed/health) • **Arma:** Fify (Flying Rez/Reclaim) |
> | **T2 Bots** | **Core:** DEADEYE (Sniper) |
> | **T2 Vehicles** | **Core:** SIEGEBREAKER (Starlight equiv) • PHANTOM (Spy Tank) • PRINTER (Field Engineer) • FORGE (Combat Engineer) • TORCH (Flame Tank) • LASER TIGER (Mobile HLT) • HEAT TIGER (Heatray Tiger) |
> | **T3** | **Arm:** MEATBALL (Amphibious Mech) • ASSIMILATOR (Anti-Spam/AA) |
> | **T2 Buildings** | **Arm:** T2 Construction Turret • Shockwave (T2 EMP Mex) • DRAGON'S FURY (T2 Popup Turret)<br>**Legion:** Advanced Metal Fortifier • DRAGON'S RAGE (T2 Popup Turret)<br>T2 Floating Construction Turret • **Core:** Advanced Armed Exploiter |
> | **T3** | **Arm:** Assimilator • Lunchbox • Meatball • Epic Pawn • Epic Recluse • Ratte • Drone Carrier<br> **Core:** Epic Grunt • Epic Karganeth • Epic Commando • Epic Tzar<br> **Legion:** Epic Goblin • Mukade • Epic Arcquebus
>
> **Code:**
```
